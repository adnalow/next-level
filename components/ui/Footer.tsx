            ...
            <ul className="grid grid-cols-3 grid-rows-2 gap-x-12 gap-y-6 items-center justify-items-center w-full">
              <li className="flex items-center gap-3 justify-center">
                <a
                  ...
                  className="hover:text-[#ff8800] transition-colors duration-200 font-semibold text-gray-300 text-base font-sans flex items-center gap-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#ff8800] focus-visible:text-[#ff8800] active:scale-95 hover:scale-105 transition-transform"
                >

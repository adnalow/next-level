    ...
    <ClientLayout>
      ...
      {updating && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
          <div className="flex flex-col items-center justify-center bg-[#232323] px-8 py-6 rounded-lg shadow-lg">
            <svg className="animate-spin h-8 w-8 text-[#FF8000] mb-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
